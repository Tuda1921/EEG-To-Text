...
from transformers import AutoTokenizer, AutoModel, OPTForCausalLM, BertLMHeadModel, BartTokenizer, BartForConditionalGeneration, BartConfig, BartForSequenceClassification, BertTokenizer, BertConfig, BertForSequenceClassification, RobertaTokenizer, RobertaForSequenceClassification, PegasusForConditionalGeneration, PegasusTokenizer, T5Tokenizer, T5ForConditionalGeneration, BertGenerationEncoder, BertGenerationDecoder, EncoderDecoderConfig, EncoderDecoderModel
from data import ZuCo_dataset
from model_decoding import BrainTranslator, BrainTranslatorNaive, T5Translator, EEG2TextModel
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'dev']:
            ...
            if phase == 'dev' and epoch_loss < best_loss:
                ...
                torch.save(model.state_dict(), checkpoint_path_best, _use_new_zipfile_serialization=False)
...
if __name__ == '__main__':
    ...
    if 'task1' in task_name:
        ...
        dataset_path_task1 = "D:/Tuda/EEG-To-Text/datasets/ZuCo/task1-SR/pickle/task1-SR-dataset.pickle"
        with open(dataset_path_task1, 'rb') as handle:
            whole_dataset_dicts.append(pickle.load(handle))
    if 'task2' in task_name:
        dataset_path_task2 = 'D:/Tuda/EEG-To-Text/datasets/ZuCo/task2-NR/pickle/task2-NR-dataset.pickle'
        with open(dataset_path_task2, 'rb') as handle:
            whole_dataset_dicts.append(pickle.load(handle))
    if 'task3' in task_name:
        dataset_path_task3 = 'D:/Tuda/EEG-To-Text/datasets/ZuCo/task3-TSR/pickle/task3-TSR-dataset.pickle'
        with open(dataset_path_task3, 'rb') as handle:
            whole_dataset_dicts.append(pickle.load(handle))
    if 'taskNRv2' in task_name:
        dataset_path_taskNRv2 = 'D:/Tuda/EEG-To-Text/datasets/ZuCo/task2-NR-2.0/pickle/task2-NR-2.0.dataset.pickle'
    ...
    elif model_name == 'T5Translator-1.1':
        tokenizer = T5ForConditionalGeneration.from_pretrained("google/t5-v1_1-large")
        #tokenizer.set_prefix_tokens(language='english')
    elif model_name == 'EEG2TextModel':
        tokenizer = EEG2TextModel.from_pretrained('facebook/bart-large')
    elif model_name == 'OPT':
    ...
    if model_name == 'BrainTranslator':
        ...
        pretrained = AutoTokenizer.from_pretrained("facebook/opt-350m")
