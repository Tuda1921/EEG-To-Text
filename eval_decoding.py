...
if __name__ == '__main__':
    ...
    if 'task1' in task_name:
        dataset_path_task1 = r'D:\Tuda\EEG-To-Text\datasets\ZuCo\task1-SR\pickle\task1-SR-dataset.pickle'
        with open(dataset_path_task1, 'rb') as handle:
            whole_dataset_dicts.append(pickle.load(handle))
    if 'task2' in task_name:
        dataset_path_task2 = r'D:\Tuda\EEG-To-Text\datasets\ZuCo\task2-NR\pickle\task2-NR-dataset.pickle'
        with open(dataset_path_task2, 'rb') as handle:
            whole_dataset_dicts.append(pickle.load(handle))
    if 'task3' in task_name:
        dataset_path_task3 = r'D:\Tuda\EEG-To-Text\datasets\ZuCo\task3-TSR\pickle\task3-TSR-dataset.pickle'
        with open(dataset_path_task3, 'rb') as handle:
            whole_dataset_dicts.append(pickle.load(handle))
    if 'taskNRv2' in task_name:
        dataset_path_taskNRv2 = r'D:\Tuda\EEG-To-Text\datasets\ZuCo\task2-NR-2.0\pickle\task2-NR-2.0-dataset.pickle'
